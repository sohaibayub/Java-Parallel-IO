...
public class SerialMicroTestsFinal {
    ...
    static void SerialReadWrite_IntBuffer(int[] iarr, int nints, boolean DEBUG) {
        try {
             ...
             */
            FileChannel fc = FileChannel.open(Paths.get("/home/08bitadnan.tmp/ibuf_serial_test.txt"),
            ...
            //long part_total = 0;
            //start = 0;
            fc = FileChannel.open(Paths.get("/home/08bitadnan.tmp/ibuf_serial_test.txt"),
                        StandardOpenOption.READ);
    ...
    static void SerialReadWrite_Mapped_IntBuffer(int[] iarr, int nints, boolean DEBUG) {
        try {
            ...
            IntBuffer ibuf;
            fc = FileChannel.open(Paths.get("/home/08bitadnan.tmp/ibuf_mapped_serial_test.txt"),
                    StandardOpenOption.CREATE,
                    StandardOpenOption.WRITE,
                    StandardOpenOption.TRUNCATE_EXISTING,
                    StandardOpenOption.READ);
    ...
    static void SerialReadWrite_Streams(int[] iarr, int nints, boolean DEBUG) {
        try {
             ...
             */
            File file = new File("/home/08bitadnan.tmp/streams_serial_test.txt");
            if (!file.exists()) {
    ...
    static void SerialReadWrite_Streams_Extensions(int[] iarr, int nints, boolean DEBUG) {
        try {
            File file = new File("/home/08bitadnan.tmp/streams_serial_extensions_test.txt");
            if (!file.exists()) {
                //System.out.println("File does not exist so creating a new file");
                try {
                    file.createNewFile();
    ...
    static void SerialReadWrite_BufferedStreams(int[] iarr, int nints, boolean DEBUG) {
        try {
             ...
             * *************** Serial Writing ( Streams ) ******************
             */
            File file = new File("/home/08bitadnan.tmp/buf_streams_serial_test.txt");
            if (!file.exists()) {
                //System.out.println("File does not exist so creating a new file");
                try {
                    file.createNewFile();
